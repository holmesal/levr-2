...
PROMOTIONS = {
			BOOST_RANK:{
					...
					'img2x' : 'http://25.media.tumblr.com/avatar_fdd788513051_128.png',
			...
			MORE_TAGS :{
					...
					'img2x'	: 'http://a0.twimg.com/profile_images/1610510720/ugly_reasonably_small.jpg',
			...
			RADIUS_ALERT : {
						...
						'img2x'	: 'http://www.levr.com/img/promo_radius@2x.png',
			...
			NOTIFY_PREVIOUS_LIKES:{
								...
								'img2x'	: 'http://f-e-a-r-forums.2310788.n4.nabble.com/file/n4151751/ugly-fat-girl-bikini-old-woman-pictures.jpg',
			...
			NOTIFY_RELATED_LIKES:{
								...
								'img2x'	: 'http://upload.wikimedia.org/wikipedia/en/4/40/Atmosphere_God_Loves_Ugly.jpg',
